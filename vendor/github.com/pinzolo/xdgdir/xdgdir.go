...
//
// 1. If XDG_CONFIG_HOME envvar is defiend, returns it.
...
//
// 1. If XDG_DATA_HOME envvar is defiend, returns it.
...
//
// 1. If XDG_CACHE_HOME envvar is defiend, returns it.
...
//
// 1. If XDG_RUNTIME_DIR envvar is defiend, returns it.
