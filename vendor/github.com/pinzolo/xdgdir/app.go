...
//
// 1. If XDG_CONFIG_HOME envvar is defined, returns $XDG_CONFIG_HOME/{{AppName}}.
// 2. IF HOME envvar is defined, returns $HOME/.config/{{AppName}}
// 3. IF USERPROFILE envvar is defined, returns $USERPROFILE/.config/{{AppName}} (for Windows)
...
//
// 1. If XDG_CONFIG_HOME envvar is defined, returns $XDG_CONFIG_HOME/{{AppName}}/{{names}}.
// 2. IF HOME envvar is defined, returns $HOME/.config/{{AppName}}/{{names}}
// 3. IF USERPROFILE envvar is defined, returns $USERPROFILE/.config/{{AppName}}/{{names}} (for Windows)
...
// 2. Search in directories that are defined at XDG_CONFIG_DIRS envvar.
...
//
// 1. If XDG_data_HOME envvar is defined, returns $XDG_DATA_HOME/{{AppName}}.
// 2. IF HOME envvar is defined, returns $HOME/.local/share/{{AppName}}
// 3. IF USERPROFILE envvar is defined, returns $USERPROFILE/.local/share/{{AppName}} (for Windows)
...
//
// 1. If XDG_data_HOME envvar is defined, returns $XDG_DATA_HOME/{{AppName}}/{{names}}.
// 2. IF HOME envvar is defined, returns $HOME/.local/share/{{AppName}}/{{names}}
// 3. IF USERPROFILE envvar is defined, returns $USERPROFILE/.local/share/{{AppName}}/{{names}} (for Windows)
...
//
// 1. If XDG_cache_HOME envvar is defined, returns $XDG_CACHE_HOME/{{AppName}}.
// 2. IF HOME envvar is defined, returns $HOME/.cache/{{AppName}}
// 3. IF USERPROFILE envvar is defined, returns $USERPROFILE/.cache/{{AppName}} (for Windows)
...
//
// 1. If XDG_cache_HOME envvar is defined, returns $XDG_CACHE_HOME/{{AppName}}/{{names}}.
// 2. IF HOME envvar is defined, returns $HOME/.cache/{{AppName}}/{{names}}
// 3. IF USERPROFILE envvar is defined, returns $USERPROFILE/.cache/{{AppName}}/{{names}} (for Windows)
...
//
// 1. If XDG_RUNTIME_DIR envvar is defined, returns $XDG_RUNTIME_DIR/{{AppName}}.
...
//
// 1. If XDG_RUNTIME_DIR envvar is defined, returns $XDG_RUNTIME_DIR/{{AppName}}/{{names}}.
// 2. Returns temporary directory path that has subdirectory named AppName.
